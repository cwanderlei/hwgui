...
if Os_IsWinNT()
  *oMainWindow:handle
   ShowNotifyInfo( GetModalHandle() , .F. , "Servidor de Proteção" , NIL, "Inicio do Teste de Ballon","Titulo Numero 1" )
