...
set HRB_DIR=D:\xharbour123_Bcc73
set HWGUI_INSTALL=d:\hwgui
...
D:\borland\BCC73\BIN\bcc32 -v -y -c %C_DEFINES% -O2 -tW -M -I%HRB_DIR%\include;%HWGUI_INSTALL%\include %1.c

if exist %1.rc D:\borland\BCC73\BIN\brc32 -r %1 -foobj\%1

echo 1 24 "..\image\WindowsXP.Manifest" > obj\hwgui_xp.rc
D:\borland\BCC73\BIN\brc32 -r obj\hwgui_xp -foobj\hwgui_xp
...
if exist %HRB_DIR%\lib\BemaFI32.lib  echo %HRB_DIR%\lib\BemaFI32.lib + >> b32.bc
if exist %HRB_DIR%\lib\mysql.lib     echo %HRB_DIR%\lib\mysql.lib + >> b32.bc
if exist %HRB_DIR%\lib\libmysql.lib  echo %HRB_DIR%\lib\libmysql.lib + >> b32.bc
pause
...
D:\borland\BCC73\BIN\ilink32 -v -Gn -Tpe -aa @b32.bc
