...
static function MudaValor(oGraph)
Local aGraph[1]
   ...
   FOR i := 1 TO ::nGraphs
      ...
      ELSEIF ::nType == 2
         ...
         FOR j := 1 TO nLen
            ...
            if j == 1
               ::tbrush := HBrush():Add( 255 )
            elseif j == 2
				   ::tbrush := HBrush():Add( 12615680 )
            elseif j == 3
				   ::tbrush := HBrush():Add( 8454143 )
            elseif j == 4
				   ::tbrush := HBrush():Add( 8421376 )
            elseif j == 5
				   ::tbrush := HBrush():Add( 16711808 )
            elseif j == 6
				   ::tbrush := HBrush():Add( 33023 )
				endif
