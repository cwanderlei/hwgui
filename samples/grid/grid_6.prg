...
//             on init {||SetGrid(oForm,oGrid,aItems)}
             ...
             for n:=1 to len(aItems)
                ADDROWEX TO GRID  oGrid header aItems[n,1] bitmap 0 color rgb(255,12,123) backcolor rgb(192,0,255) ,;
                                        header aItems[n,2]  ,;
                                        header aItems[n,3] bitmap 3  ,;
                                        header aItems[n,1] bitmap 1 color rgb(123,122,123)  backcolor rgb(192,0,255)
             next
