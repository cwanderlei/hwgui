...
//        oButtonex1:lNoThemes := .T.
   ...
   @ 597,276 BUTTONEX oButtonex3 CAPTION "Redução Z"   SIZE 183,38 ;
        STYLE BS_CENTER +WS_TABSTOP
   ...
   @ 426,189 SAY oLabel6 CAPTION "25,00"  SIZE 142,40 ;
        ...
        FONT HFont():Add( '',0,-32,400,,,)
        oLabel6:Anchor := 161
   @ 11,57 SAY oLabel5 CAPTION "Descrição do Produto"  SIZE 777,27 ;
        STYLE SS_CENTER   ;
   ...
   @ 11,155 SAY oLabel10 CAPTION "Quantidade"  TRANSPARENT SIZE 147,27 ;
        ...
        FONT HFont():Add( 'Arial',0,-19,400,,,)
        oLabel10:Anchor := 161
   @ 209,155 SAY oLabel3 CAPTION "Valor Unitário"  TRANSPARENT SIZE 150,27 ;
        STYLE SS_CENTER ;
         COLOR 16777215   ;
        FONT HFont():Add( 'Arial',0,-19,400,,,)
        oLabel3:Anchor := 161
