 ...
 * Command: /D__EXPORT__ /DHB_FM_STATISTICS_OFF /iinclude;d:\xHarbour\include /q0 /w0 /es2 /n1 /gc0 source\errorsys.prg -osource\errorsys.c 
 * Created: 2012.04.25 20:42:33 (Borland C++ 5.5.1 (32 bit))
 */
...
{ "ERRORSYS", {HB_FS_PUBLIC | HB_FS_LOCAL}, {HB_FUNCNAME( ERRORSYS )}, &ModuleFakeDyn },
...
HB_FUNC_STATIC( ERRORPREVIEW )
{
   static const BYTE pcode[] =
   {
	...
	0,0,0,108,46,100,12,0,6,100,100,100,100,112,
	17,73,48,47,0,95,2,112,0,73,134,9,100,110,
	7
   };
