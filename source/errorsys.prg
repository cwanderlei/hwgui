...
STATIC FUNCTION ErrorPreview( cMess )
   ...
   INIT DIALOG oDlg TITLE "Error.log" ;
        At 92, 61 SIZE 700, 500

   @ 10, 10 EDITBOX oEdit CAPTION cMess SIZE 676, 440 STYLE WS_VSCROLL + WS_HSCROLL + ES_MULTILINE + ES_READONLY ;
      COLOR 16777088 BACKCOLOR 0 ;
      ON GETFOCUS { || SendMessage( oEdit:handle, EM_SETSEL, 0, 0 ) }

   @ 300, 460 BUTTON "&Fechar" ON CLICK { || EndDialog() } SIZE 100, 32
